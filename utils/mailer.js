...
export async function welcomeMail(userEmail, fullName = "Valued Customer") {
	try {
      ...
      <td style="padding: 20px; line-height: 1.8;">
        <p>Dear ${fullName},</p>
        <p>Welcome Aboard to Fin-Forte Club!</p>
        <p>
        ...
        <p>
          ...
          to our support team at support@Fin-Forte.com.
        </p>
        <p>Best regards</p>
        <p>The Fin-Forte Team</p>
      </td>
    `;

		let mailOptions = {
			from: `Fin-Forte ${process.env.SMTP_USER}`,
			to: userEmail,
			subject: "Welcome Aboard to Fin-Forte Club",
	...
	try {
        ...
        <td style="padding: 20px; line-height: 1.8;">
          ...
          <p>
            ...
            You can now use your funds to trade on Fin-Forte.
          </p>
          <p>
            If you have questions or need assistance, reach out 
            to our support team at support@Fin-Forte.com.
